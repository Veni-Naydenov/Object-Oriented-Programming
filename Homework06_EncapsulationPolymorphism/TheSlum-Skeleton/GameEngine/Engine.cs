namespace TheSlum.GameEngine
{
    ...
    using TheSlum.Items;
    using TheSlum.Items.BonusItems;
    ...
    public class Engine
    {
        ...
        ////if ApplyItemEffects was public !
        //private static void ApplyItemEffectByType(Character itemOwner, string type, Bonus item)
        //{
        //    if (type == "Mage")
        //    {
        //        (itemOwner as Mage).ApplyItemEffects(item);
        //    }
        //    else if (type == "Warrior")
        //    {
        //        (itemOwner as Warrior).ApplyItemEffects(item);
        //    }
        //    else if (type == "Healer")
        //    {
        //        (itemOwner as Healer).ApplyItemEffects(item);
        //    }
        //}
